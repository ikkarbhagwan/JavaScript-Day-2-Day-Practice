...
const toUppercaseNum = strings.map(str => str.toLocaleUpperCase());
console.log(toUppercaseNum);
...
const findLength = words.filter(function (word){
...
const strings4 = ["level", "hello", "radar", "world"];


const palindromes = strings4.filter(str => str === str.split('').reverse().join(''));
